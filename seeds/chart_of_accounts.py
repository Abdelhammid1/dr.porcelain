...
CHART_OF_ACCOUNTS: list[tuple[str, str, T, bool, str | None]] = [
    ...
    ("2300", "أقساط مستحقة على العملاء (تحكم)", T.LIABILITY, False, "2000"),
    # Ticket 3 Epic 4 — إضافات
    ("2400", "قروض قصيرة الأجل", T.LIABILITY, True, "2000"),
    ("2500", "قروض طويلة الأجل", T.LIABILITY, True, "2000"),

    # ================= حقوق الملكية =================
    ("3000", "حقوق الملكية", T.EQUITY, False, None),
    ("3100", "رأس المال", T.EQUITY, True, "3000"),
    # Ticket 3 Epic 4 — إضافات
    ("3150", "أرصدة افتتاحية", T.EQUITY, True, "3000"),
    ("3200", "الأرباح المحتجزة", T.EQUITY, True, "3000"),
    ("3300", "مسحوبات صاحب المتجر", T.EQUITY, True, "3000"),
    ("3400", "أمانات (Deposits)", T.LIABILITY, True, "2000"),
